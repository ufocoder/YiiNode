...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row">
        ...
        <?php echo $form->dropDownList($model,'field_type',ProfileField::values ('field_type')); ?>
    </div>
    ...
    <div class="row">
        ...
        <?php echo $form->dropDownList($model,'required',ProfileField::values ('required')); ?>
    </div>
    ...
    <div class="row">
        ...
        <?php echo $form->dropDownList($model,'visible',ProfileField::values ('visible')); ?>
    </div>
