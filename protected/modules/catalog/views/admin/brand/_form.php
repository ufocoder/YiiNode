<?php
    ...
    if ($model->isNewRecord)
        $action = Yii::app()->createUrl('/brand/create', array('nodeAdmin'=>true, 'nodeId'=>$nodeId));
    else
        $action = Yii::app()->createUrl('/brand/update', array('nodeAdmin'=>true, 'nodeId'=>$nodeId, 'id'=>$model->id_brand));
...
<?php echo $form->errorSummary($model); ?>
    ...
    <?php echo $form->textFieldRow($model, 'position', array('class'=>'span4')); ?>
    <?php echo $form->checkBoxRow($model, 'enabled', array()); ?>
