<?php
    ...
    if ($model->isNewRecord)
        $action = Yii::app()->createUrl('/field/create', array('nodeAdmin'=>true, 'nodeId'=>$nodeId));
    else
        $action = Yii::app()->createUrl('/field/update', array('nodeAdmin'=>true, 'nodeId'=>$nodeId, 'id'=>$model->id_field));
...
?>
    ...
    <?php else: ?>
        <?php echo CHtml::tag("div", array('field'=>'field_type'), $form->dropDownListRow($model, 'field_type', CatalogField::values('field_type'), array('class'=>'span4', 'id'=>'field_type'))); ?>
    <?php endif; ?>
