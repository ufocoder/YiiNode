<?php
    ...
    if ($model->isNewRecord)
        $action = Yii::app()->createUrl('/image/create', array('nodeAdmin'=>true, 'nodeId'=>$nodeId, 'id_product' => $this->data_product->id_product));
    else
        $action = Yii::app()->createUrl('/image/update', array('nodeAdmin'=>true, 'nodeId'=>$nodeId, 'id_product' => $this->data_product->id_product, 'id'=>$model->id_image));
